...
import {  fetchNewConstumers } from '../actions/consumerActions';
    ...
    return(
      ...
      <div className="container-flud">
        ...
        <Address
          ...
          village_other_khm={this.state.village_other_khm}
          village_other_eng={this.state.village_other_eng}
...
export default connect(mapStateToProps, { fetchNewConstumers })(Enquiryform);